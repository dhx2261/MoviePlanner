...
public class AscendingSortListener implements View.OnClickListener{
    EventModel model1;
    EventArrayAdapter myArrayAdapter;
    ListView el;

    public AscendingSortListener(EventArrayAdapter myArrayAdapter, ListView el) {
    ...
    public void onClick(View v) {
        ...
        Collections.sort(list, new Comparator<Map.Entry<String, EventImpl>>() {
            public int compare(Map.Entry<String, EventImpl> o1, Map.Entry<String, EventImpl> o2) {
                if (o1.getValue().getSdate().before(o2.getValue().getSdate())) {
                    return -1;
